...
CREATE INDEX idx_GeoEon ON Geostrat.GeoEon(id_eon);
...
CREATE INDEX idx_GeoEra ON Geostrat.GeoEra(id_era);
...
CREATE INDEX idx_GeoOkres ON Geostrat.GeoOkres(id_okres);
...
CREATE INDEX idx_GeoEpoka ON Geostrat.GeoEpoka(id_epoka);
...
CREATE INDEX idx_GeoPietro ON Geostrat.GeoPietro(id_pietro);
